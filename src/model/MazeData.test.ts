  ...
  describe('pillsMatrix', () => {
    it('returns the pills in the initial Maze', () => {
      ...
      expect(pillsMatrix[1]).toEqual(
        // prettier-ignore
        [ 0, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 900, 0 ]
      );
    });
  });
  ...
  describe('waysMatrix', () => {
    it('returns the ways in the Maze', () => {
      ...
      expect(waysMatrix[1]).toEqual(
        // prettier-ignore
        [ 0, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 869, 0 ]
      );
    });
  });
});
